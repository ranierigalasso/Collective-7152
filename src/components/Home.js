    ...
    return (
      <div className='main-div'>
        ...
        <div className="container">
          <div className=""><img id="first-img" src={require("../images/3.jpg")} alt=""/></div>
          <div className=""><img src={require("../images/2.jpg")}  alt=""/></div>
          <div className=""> <img src={require("../images/1.jpg")}  alt=""/></div>
          <div className=""><img src={require("../images/4.jpg")}  alt=""/></div>
          <div className=""><img src={require("../images/5.jpg")}  alt=""/></div>
        </div>
      </div>
    )
  }
